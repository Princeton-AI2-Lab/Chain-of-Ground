...
class Qwen3VL235BDualMethod:  
    def __init__(self,   
        ...
        Args:
            uitars_model: Preserve original parameter (backward compatibility)
            qwen_model: Qwen model name (Dashscope format)
            uitars_api_base: Preserve original parameter (backward compatibility)
    ...
    def ground_only_positive(self, instruction, image):
        ...
        # Layer 2: call Qwen correction - pass resized image and coordinates
